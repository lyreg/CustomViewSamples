...
/**
 * 滑动关闭页面基类，使用时继承此类并相应activity的style里加入以下内容即可
 * <item name="android:windowBackground">@android:color/transparent</item>
 * <item name="android:windowIsTranslucent">true</item>
 */
public class SwipeBackToFinishActivity extends AppCompatActivity {
    ...
    public SwipeBackToFinishActivity() {
    ...
    class SwipeLayout extends FrameLayout {
        ...
        public boolean dispatchTouchEvent(@NonNull MotionEvent ev) {
            Log.e("dispatchTouchEvent", "swipeEnabled : " + swipeEnabled + " canSwipe: " + canSwipe + " ignoreSwipe: " + ignoreSwipe);
